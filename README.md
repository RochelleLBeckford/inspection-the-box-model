...
### Practce understanding CSS -> The Box Model
...
-   [ ] CSS The Box Model:
    ...
    -   [ ] This is what the box model looks like in the browser using the inspect tool:
        -   [ ] <img src="img/c-box-model-in-the-web-browser.png" alt="The Box Model in the Web Browser" class="img-the-box-model">
